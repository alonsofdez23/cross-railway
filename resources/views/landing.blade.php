	...
	<div class="w-full container mx-auto p-6">
		...
		<div class="w-full flex items-center justify-between">
			...
			<div class="flex w-1/2 justify-end content-center">
				...
				{{-- <a class="inline-block text-purple-400 no-underline hover:text-purple-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4" data-tippy-content="@twitter_handle" href="https://twitter.com/intent/tweet?url=#">
				...
				<a class="inline-block text-purple-400 no-underline hover:text-purple-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 " data-tippy-content="#facebook_id" href="https://www.facebook.com/sharer/sharer.php?u=#">
